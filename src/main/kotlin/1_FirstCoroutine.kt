...
fun main(){
    ...
    */
    ...
    GlobalScope.launch{....}
    This creates a coroutine but coroutine needs aa thread to run so it uses Dispatcher.default
    Default-->Background pool of real OS threads (usually 4-8 threads)
